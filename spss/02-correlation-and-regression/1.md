...
3.	Produce a correlation matrix of all the predictor variables (where you've created a transformed variable, use that instead of the original) and the dependent variable (i.e., academic performance). Interpret the pattern of results. 
